          ...
          <div className=" w-full p-4 sm:p-8 flex flex-col gap-6 overflow-auto ">
            <div className=" pb-5">
              ...
              <p className="text-app-gray-500 mt-1">
                Recharge my account balance for sending messages to inmates.
                This does not send money to inmates.
              </p>
            </div>
            {step === 0 && (
              <div>
            ...
            {step === 1 && (
              <div>
                ...
                <div className="flex items-center gap-5 w-full justify-center mt-14">
                  <PrimaryButton className="max-w-xs w-full" action={() => setStep(2)}>
                    Add funds
                  </PrimaryButton>
                  <NegativeButton className="max-w-xs w-full">
                    Cancel
            ...
            {step === 2 && (
              <div className="items-center gap-12 flex flex-col flex-1 justify-center">
                ...
                <PrimaryButton action={() => setStep(0)}>Return to the Main Page</PrimaryButton>
              </div>
            )}
          </div>
        </div>
